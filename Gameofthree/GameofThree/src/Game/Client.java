...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Socket socket = new Socket("localhost", 1342)) {
            ...
            if(isValidChoice) {
                if (choice.equalsIgnoreCase("M")) {
                    ...
                    numberByClient = sc.nextLine();
                    out.println(numberByClient);
                    out.flush();                    
                } 
                else{ 
                	 numberByClient = String.valueOf(generateRandomNumber(MIN_RAND, MAX_RAND));                 	 
                	 out.println(numberByClient);                	 
                }
            }
            ...
            while (true) {
                ...
                try {
                    ...
                    if(!printNumber) {                   	  
                        	...
                        	System.out.println("The number generated by client is : " +numberByClient);
                        	printNumber = true;                        
                    }
